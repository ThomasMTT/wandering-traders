...
public class PotionTraderModel<T extends PotionTraderEntity> extends EntityModel<T> {
	...
	public PotionTraderModel(ModelPart root) {
        ...
        this.hat2 = this.headwear2.getChild("hat2");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition headwear2 = partdefinition.addOrReplaceChild("headwear2", CubeListBuilder.create().texOffs(0, 64).addBox(0.0F, 0.0F, 0.0F, 10.0F, 2.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, -10.05F, -5.0F));

        PartDefinition hat2 = headwear2.addOrReplaceChild("hat2", CubeListBuilder.create().texOffs(0, 76).addBox(0.0F, 0.0F, 0.0F, 7.0F, 4.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.75F, -4.0F, 2.0F, -0.0524F, 0.0F, 0.0262F));
