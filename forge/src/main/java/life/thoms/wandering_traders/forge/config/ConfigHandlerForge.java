package life.thoms.wandering_traders.forge.config;
...
public class ConfigHandlerForge {
    ...
    public static final ForgeConfigSpec.BooleanValue ENABLE_ANIMAL_TRADER_SPAWN;
    public static final ForgeConfigSpec.BooleanValue ENABLE_BOOK_TRADER_SPAWN;
    public static final ForgeConfigSpec.BooleanValue ENABLE_DECORATION_TRADER_SPAWN;
    public static final ForgeConfigSpec.BooleanValue ENABLE_EXCLUSIVE_TRADER_SPAWN;
    public static final ForgeConfigSpec.BooleanValue ENABLE_FOREST_TRADER_SPAWN;
    public static final ForgeConfigSpec.BooleanValue ENABLE_POTION_TRADER_SPAWN;

    // Loot recovery settings
    public static final ForgeConfigSpec.BooleanValue ENABLE_LOOT_RECOVERY;

    // Bell drop settings
    public static final ForgeConfigSpec.BooleanValue ENABLE_END_BELL_DROP;

    // Actionbar message settings
    public static final ForgeConfigSpec.BooleanValue MESSAGES_TO_ACTIONBAR;

    // Trader despawn time
    public static final ForgeConfigSpec.IntValue TRADER_DESPAWN_TIME;
